  ...
  try {
    ...
    const subFeatures = [
      ...
      },
      {
        ...
        icon: 'CashRegister',
        defaultActions: JSON.stringify(['read', 'update', 'delete', 'manage']),
        parentKey: 'operations',
      },
      {
        key: 'coupons',
    ...
    const plans = [
      ...
      },
      {
        ...
        features: JSON.stringify(['dashboard', 'product', 'category', 'complement', 'order', 'customer', 'pdv', 'kds', 'stock', 'delivery', 'delivery_person', 'delivery_area', 'payment_method', 'cash_register', 'coupons', 'reports', 'analytics', 'user', 'group', 'branch']),
        active: true,
        displayOrder: 3,
      },
      {
